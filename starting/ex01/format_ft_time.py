...
# First I need to get seconds from 1 1 1970.
# and formatted to be like this 1,000,000
# that why I use time.time to get it the time
# and formatted to be like what we want,
...
print(f"Seconds since January 1, 1970: {time_in_seconds} \
    or {time_in_scientific} in scientific notation")
print(tody_date)
