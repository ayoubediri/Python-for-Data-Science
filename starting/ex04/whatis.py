...
The first concept is taking arguments from the user before running the program, for which we use the sys module.
...
The second concept is using try and except to check if the syntax works correctly and to prevent the program from crashing when an error occurs.
