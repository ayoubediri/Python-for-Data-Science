...
def give_bmi(height: list[int | float], weight: list[int | float]) -> list[int | float]:
    """
    This function takes in two lists: height and weight, and returns a list of BMI values.
    
    The BMI is calculated using the formula: weight / (height ** 2)
    
    The height should be in meters and weight in kilograms.
    
    The function raises a ValueError if the height or weight is less than or equal to 0.
    
    The function raises a TypeError if the height or weight is not a number.
    
    The function raises a ValueError if the height and weight lists are not of the same length.
...
def apply_limit(bmi: list[int | float], limit: int) -> list[bool]:
    """
    This function takes in a list of BMI values and a limit, and returns a list of booleans indicating
    ...
    list[bool]: A list of booleans indicating whether each BMI value is less than the limit.
    """
